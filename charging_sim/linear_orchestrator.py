...
class ChargingSimLinear:
    ...
    def create_charging_stations(self, power_nodes):
        """
        Creates the charging station objects within the power network (MPC mode). The main difference between this
        method and the create_charging_stations_oneshot method is that this method creates the charging stations while
        using the MPC controller, whereas the create_charging_stations_oneshot  method creates the charging stations
