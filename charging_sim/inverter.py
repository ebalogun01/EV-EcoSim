...
class Inverter:
    ...
    Photovoltaic Specialist Conference (PVSC), June 2008
    [2] William F. Holmgren, Clifford W. Hansen, and Mark A. Mikofski. “pvlib python: a python package for modeling
    solar energy systems.” Journal of Open Source Software, 3(29), 884, (2018). https://doi.org/10.21105/joss.00884

    Each instantiation of this class must include at least a config file, which contains the physical
    constraints and properties of the inverter.

    Properties are mainly controlled in the inverter config file 'inverter.json'
