...
export type UseNumberInputChangeHandler = (e: React.KeyboardEvent<HTMLInputElement>, value: number | null) => void;
...
export type UseNumberInputRootSlotProps<TOther = {}> = Omit<TOther, keyof UseNumberInputRootSlotOwnProps | 'onBlur' | 'onInputChange' | 'onFocus'> & UseNumberInputRootSlotOwnProps;
...
export type UseNumberInputInputSlotProps<TOther = {}> = Omit<TOther, keyof UseNumberInputInputSlotOwnProps> & UseNumberInputInputSlotOwnProps;
...
export type UseNumberInputIncrementButtonSlotProps<TOther = {}> = Omit<TOther, keyof UseNumberInputIncrementButtonSlotOwnProps> & UseNumberInputIncrementButtonSlotOwnProps;
...
export type UseNumberInputDecrementButtonSlotProps<TOther = {}> = Omit<TOther, keyof UseNumberInputDecrementButtonSlotOwnProps> & UseNumberInputDecrementButtonSlotOwnProps;
export interface UseNumberInputReturnValue {
     ...
     */
    getDecrementButtonProps: <TOther extends Record<string, any> = {}>(externalProps?: TOther) => UseNumberInputDecrementButtonSlotProps<TOther>;
    /**
     ...
     */
    getIncrementButtonProps: <TOther extends Record<string, any> = {}>(externalProps?: TOther) => UseNumberInputIncrementButtonSlotProps<TOther>;
    /**
     * Resolver for the input slot's props.
     * @param externalProps props for the input slot
     * @returns props that should be spread on the input slot
     */
    getInputProps: <TOther extends Record<string, any> = {}>(externalProps?: TOther) => UseNumberInputInputSlotProps<TOther>;
    /**
     * Resolver for the root slot's props.
     * @param externalProps props for the root slot
     * @returns props that should be spread on the root slot
     */
    getRootProps: <TOther extends Record<string, any> = {}>(externalProps?: TOther) => UseNumberInputRootSlotProps<TOther>;
    /**
